...
const VERSION = 'TallyOne 3.43-01';
const NOTE = '콘앱 미르가 검수앱과 같은 자료(터미널 실적·배 속도·도선 예보)를 보고 답합니다. 몇 시에 끝나, 얼마나 했어, 실제 진행 상황이 두 앱에서 같은 답이 됩니다';   // build.sh 가 utils APP_NOTE 로 채운다
