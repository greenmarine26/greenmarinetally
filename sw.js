...
const VERSION = 'TallyOne 3.60-14';
const NOTE = '복원한 항차가 7일 동안 저절로 사라지지 않습니다 · 선사 엠티 리스트의 목적항을 POD 로 · 터미널 검수 입력 자료의 씰 칸을 제대로 읽습니다';   // build.sh 가 utils APP_NOTE 로 채운다
