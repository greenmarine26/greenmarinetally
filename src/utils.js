...
export const APP_VERSION = 'TallyOne 3.51-01'   // 3.51-01 ①호기 검수원·갱 수·작업 시작·시퀀스 방침은 조회만도 적는다(관리 기록이지 내 검수 작업이 아니다 — 검수사 «미르에게 작업자 등록했는데 왜 적용이 안된건지») ②크롬 자동완성이 로그인 이름을 흰 배경에 묻어 안 보이던 것(특정 노트북) · 3.51 조회만은 보기만
...
export const APP_NOTE = '조회만으로도 호기 검수원·갱 수·작업 시작 시각은 그대로 등록됩니다. 로그인 이름 칸에 글자가 안 보이던 노트북도 고쳤습니다'
