...
export const APP_NOTE = '베이매트릭스 정리 — 지금 안 다니는 배는 보조 보관함으로 감추고 입항하면 저절로 돌아옵니다';
