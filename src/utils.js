...
export const APP_VERSION = 'TallyOne 2.34-09';   // **미르 완전체 — 검수사가 직접 쓴 원고 4부작을 전부 주입** — «미리 검수 실무를 다 주입 시켜 주세요». ①용어 200선(기본 100+실무 100, 문답 원고) ②스마트·세관 15(HHT·OCR·보세구역·CEDEX·흘수·체선료) ③초고수 25(USDA·CA·디프로스트·젠셋·EmS·인화점·IICL·수광검사·Foul B/L·LOR·AGV·TOS) ④사회생활 만렙 막내 — 상황 인사 시전 8종(출근·퇴근·식사·복귀·실수 위로·칭찬)+가르침 5종(인사법·복창보고·쿠션어·위기대응·3대팁). 반말 원고는 존칭 확정에 따라 해요체 기계 변환(내용 무변경·잔존 0). 총 266문답 · 별칭 150여 · 상황 서술 발동 · 시간/집계 조회는 업무 몫 가드. 시뮬 누적 90여 케이스 PASS.
