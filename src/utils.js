...
export const APP_NOTE = '미르에게 묻고 나면 칸이 비고 물은 말은 답 위에 남습니다. 카고플랜을 열 때 양하 선적을 다시 묻지 않고, 작업중인 배라고 하면 지금 일하는 배로 답합니다';   // 3.41   // 3.40   // 3.39-03   // 3.39-02 · ConeOne 2.46   // 3.39-01
