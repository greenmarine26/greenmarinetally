...
export const APP_NOTE = '로그인 뒤 작업 선박을 고릅니다. 검수원은 고른 선박 안에서만 앱이 돌고, 수석과 검수사는 조회만 또는 작업자를 골라 들어옵니다. 조회만이면 호기가 기록되지 않습니다'
