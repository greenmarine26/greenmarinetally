...
export const APP_NOTE = '작업 속도를 전체 작업 시간으로 계산합니다. 손으로 친 컨번호는 검산해서 오타를 짚어 드립니다';
