...
export const APP_NOTE = '미르가 못 알아들은 말은 AI가 미르 말로 바꿔 다시 답하고, 규칙에 없는 것은 자료를 보고 답합니다. 답 끝에 AI 표시가 붙으면 자료를 읽고 만든 문장이니 숫자는 화면에서 한 번 더 보세요';   // 3.41   // 3.40   // 3.39-03   // 3.39-02 · ConeOne 2.46   // 3.39-01
