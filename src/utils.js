...
export const APP_VERSION = 'TallyOne 1.76-04';   // 되돌림 — 1.76-03(40ft 먼저 복원·해치 배너·실번호 중복 알림) 전량 철회, 코드는 1.76-02 와 동일하다. 검수사 지시 2026-08-16 «오늘 수정한거 복구해놔요 원래대로». 버전만 올린 이유는 폰 서비스워커 캐시가 1.76-03 을 물고 있어서다(1.74-01→1.74-02 되돌림과 같은 방식).
