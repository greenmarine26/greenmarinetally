...
export const APP_VERSION = 'TallyOne 2.10-02';   // 검수사 «**평택항만공사 공식 파트너 · PYEONGTAEK PORT** 이내용은 위험 합니다. 다른걸로 바꿔주세요» — PC 로그인 좌측 배지 문구를 «그린마린 검수팀 전용 · 평택항 컨테이너 검수»로 교체. 공적 기관과의 제휴로 읽힐 수 있는 표현은 쓰지 않는다(앱 헤더에 이미 쓰는 «그린마린 검수팀 전용» 과 같은 표현). ⚠ 시안에서 온 문구를 검증 없이 그대로 실은 내 잘못 — **시안의 문구도 사실인지 따진다.**
