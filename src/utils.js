...
export const APP_NOTE = '플랜 칸 오른쪽 위 목적지 글자를 작게 줄이고 구석으로 떼어 놓았습니다 — 화물 표기와 붙어 보이던 것';
