...
export const APP_VERSION = 'TallyOne 3.52'   // 3.52 ①세관리스트 «선사부호» 가 선사 기준이다(검수사 «SOC가 있는 선박은 선사기준을 세관리스트로 합니다») — EDI 선사 칸에 SOC·OLL 같은 선사 아닌 값이 와도 잡힌다 ②세관 규격 `42HQ`(40ft 하이큐브) 가 빈칸이 되어 같은 원문이 두 규격으로 갈리던 것
...
export const APP_NOTE = '선사는 이제 세관리스트를 기준으로 봅니다. 세관 규격 42HQ 가 비어 나오던 것도 고쳤습니다'
