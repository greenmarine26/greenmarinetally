...
export const APP_NOTE = '실시간 작업 보드 — 호기마다 지금 작업 중인 베이 그림이 그대로 보이고, 왼쪽 별첨 표가 완료/전체로 실시간으로 채워집니다';
