...
export const APP_NOTE = '끝자리 같은 컨이 두 대면 자리를 보고 고르게 바꿨습니다 — 하나를 확인해도 남은 컨이 확인 카드로 안 올라옵니다';
