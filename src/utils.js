...
export const APP_VERSION = 'TallyOne 1.76-03';   // 버그픽스 3건 (검수사 메모 2026-08-16, MAMP 631N 작업 중 신고) — ① 양하 «40ft 먼저» 고정 규칙 복원(1.57 에서 감지로 옮겼던 것). 감지가 규격을 부류(풀·엠티·리퍼) 다음에 봐서 40ft 를 수십 대 연속으로 쳐도 「40 흐름」에 도달 못 했다. 실측 11:26~11:28 — 34-05-04(40) → 33/35-06-02 트윈(20) → 34-05-02(40). 20 흐름·칩이 걸리면 종전대로 감지가 이긴다 ② 해치커버 오픈 배너가 «커버 위 화물» 게이트(1.8-19)와 `&& card` 두 겹에 막혀 나오지 않던 것 — MAMP 34 그룹은 통과화물 CAAU9967900 한 대 때문에 영구 무음이었다. 배너를 띄우되 «커버 위 통과화물 N대 — 치워야 열립니다(시프팅)»로 문구를 가른다 ③ 실번호(봉인) 중복이 화면에 한 번도 안 뜨던 것 — PH0570668 이 MNBU3256200·MNBU4383895 두 대에 들어간 채 둘 다 완료. 작업 카드 경고 + 목록 배지 신설
