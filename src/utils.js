...
export const APP_NOTE = '베이뷰가 컴에서는 좌우로 나뉩니다. 따라가기를 켜면 해치커버 열고 닫음을 터미널 실적으로 앱이 판정해 보고에 적고, 따라가기가 아니면 알림으로 묻습니다. 검수원이 먼저 보고한 것이 우선입니다'
