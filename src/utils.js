...
export const APP_NOTE = '계획 자리를 남에게 내준 컨은 그 컨이 비운 자리로 자동으로 옮겨 보입니다 — 겹침·빈칸 없이 남은 컨 번호가 다 보입니다';
