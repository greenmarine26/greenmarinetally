...
export const APP_NOTE = '베이뷰 작업이 생겼습니다. 작업 시작에서 베이뷰를 고르면 위는 컨테이너 자료, 아래는 작업 중인 베이가 실시간으로 보입니다. 기존 방식은 그대로입니다'
