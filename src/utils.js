...
export const APP_NOTE = '미르 남은 대수는 홈 카드와 같은 리스트 기준입니다 · 조회만 폰은 항차를 자동 정리하지 않습니다 · 무엇의 위치인지 없는 물음은 되묻습니다 · 씰체결 엑셀 시트 이름과 검수리스트 별첨 제목을 바로잡았습니다'
