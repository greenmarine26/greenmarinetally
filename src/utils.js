...
export const APP_NOTE = '베이 상세 칸에 X-RAY 봉인번호가 노란 바탕으로 나옵니다 — 칸 크기는 종전 그대로입니다'
...
const ISO_TYPE_GROUP = new Set(['GP', 'RE', 'RT', 'RS', 'PF', 'PL', 'UT', 'TN', 'TG', 'TD', 'BU', 'SN', 'VH', 'HR', 'AC']);
