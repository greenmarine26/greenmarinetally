...
export const APP_NOTE = '작업 속도를 접안부터 이안까지 일한 시간으로 나눕니다 — 몰아 찍으셔도 같은 값이 나옵니다';
