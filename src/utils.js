...
export const APP_NOTE = '손으로 적은 선적 기록지를 사진으로 찍어 넣으면 선적 자리가 들어갑니다 — 검수 탭 선적에서 기록지 사진 버튼. 콘앱도 그 자리를 보입니다'
