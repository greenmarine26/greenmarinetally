...
export const APP_VERSION = 'TallyOne 3.51'   // 3.51 **조회만은 보기만** — 호기 지정·자동 가이드·베이뷰는 전부 되고(3.50 이 잘못 막았다) 완료·보고·취소·초과·자리수정 **쓰기만** 막는다(문지기는 firebase 쓰기 자리). 남의 배를 열람해도 그 배가 수석 보드에 «작업 중» 으로 안 뜬다 · 3.50-02 캔슬 리스트 · 3.50-01 늦은 직책
...
export const APP_NOTE = '조회만으로 들어와도 호기 지정과 자동 가이드·베이뷰를 그대로 보실 수 있습니다. 완료와 작업 보고만 막고, 다른 선박을 조회해도 그 배가 작업 중으로 뜨지 않습니다'
