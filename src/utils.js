...
export const APP_NOTE = '리스트의 45HC 는 45피트로 읽습니다 · B/L 여러 줄로 나온 컨의 무게는 컨 합계 무게로 읽습니다'
...
export async function parseListExcel(arrayBuffer) {
  ...
  for (const sheetName of wb.SheetNames) {
    ...
    for (let i = headerRow + 1; i < grid.length; i++) {
      ...
      if (_podV && _podViaHdr2) _podV = _listPortCode(_podV) || _podV;   // 2차 머리 칸(XTPG «DIS» 'KRPTK,PYEONGTAEK')은 다섯 글자 코드로 — 수집기 평택 판정과 같게
