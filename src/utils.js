...
export const APP_NOTE = '베이뷰 선택 화면에서 호기 단추를 누르면 그 호기가 내 호기로 바로 지정됩니다. 호기 지정 메뉴가 먼저 뜨지 않습니다. 컴 화면은 베이가 통째로 한눈에 들어옵니다'
