...
export const APP_NOTE = '선사가 보내는 시프팅 목록(RESTOW LIST)이 오면 그것을 정본으로 씁니다. 앱 추정과 다르면 둘 다 보여 줍니다';   // 3.43-03 카고플랜과 베이플랜에서 플랫랙(FR)이 OT로 잘못 표시되던 것을 고쳤습니다. 콘앱 카고플랜과 베이뷰도 같이 고쳤습니다   // 3.43-02 씰이 잘리거나 파손됐을 때 대처법을 물으면 씰 번호 안내가 아니라 현장 절차(사진과 리씰)로 답합니다. 콘앱 미르도 같은 답입니다   // 3.43-01 콘앱 미르가 검수앱과 같은 자료(터미널 실적·배 속도·도선 예보)를 보고 답합니다…   // 3.43 사진 인식·PDF 베이·선박 소개·검색패널 AI가 이제 공용 키(검수사 부담)로 돕니다…   // 3.42 미르가 못 알아들은 말은 AI가 미르 말로 바꿔 다시 답하고…   // 3.41   // 3.40   // 3.39-03   // 3.39-02 · ConeOne 2.46   // 3.39-01
