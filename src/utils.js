...
export const APP_NOTE = '규격이 EDI · 선사리스트 · 세관리스트에서 다른데 아무 알림이 없던 것을 고쳤습니다 — 이제 알려 드리고 양하·선적할 때 실물을 보고 맞는 것을 고르실 수 있습니다. 지난 항차는 자료를 다시 올리거나 자료 재처리를 한 번 눌러 주세요'
