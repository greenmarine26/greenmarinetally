...
export const APP_NOTE = 'SMC YANTAI 선박코드를 터미널대로 SMYA로 정정(선사 RZF·항로 RZPT) · RZOR 대체 카페리로 주야 구분 없음';
