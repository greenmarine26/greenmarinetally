...
export const APP_NOTE = '콘앱 미르가 검수앱과 같은 자료(터미널 실적·배 속도·도선 예보)를 보고 답합니다. 몇 시에 끝나, 얼마나 했어, 실제 진행 상황이 두 앱에서 같은 답이 됩니다';   // 3.43 사진 인식·PDF 베이·선박 소개·검색패널 AI가 이제 공용 키(검수사 부담)로 돕니다…   // 3.42 미르가 못 알아들은 말은 AI가 미르 말로 바꿔 다시 답하고…   // 3.41   // 3.40   // 3.39-03   // 3.39-02 · ConeOne 2.46   // 3.39-01
