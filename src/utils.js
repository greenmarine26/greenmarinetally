...
export const APP_NOTE = '양하 순서에 해상부터 추가 — 자동 가이드 접안 칩 옆 [해상부터] 버튼(케빈이 해상부터 내릴 때)';
