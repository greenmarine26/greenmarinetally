...
export const APP_NOTE = '터미널 검수 입력 파일의 선사 칸을 읽습니다 · 리스트의 SOC -EMPTY 는 엠티입니다 · 리스트 항구 약칭(TAO 등)은 앱 항구 코드로 맞춥니다'
