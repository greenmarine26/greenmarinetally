...
export const APP_NOTE = '사진 인식·PDF 베이·선박 소개·검색패널 AI가 이제 공용 키(검수사 부담)로 돕니다. 본인 키를 넣지 않아도 되고, 오래 걸리면 기다리다 멈추지 않고 시간 초과를 알립니다';   // 3.42 미르가 못 알아들은 말은 AI가 미르 말로 바꿔 다시 답하고…   // 3.41   // 3.40   // 3.39-03   // 3.39-02 · ConeOne 2.46   // 3.39-01
