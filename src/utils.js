...
export const APP_NOTE = '플랜의 포트 격자를 없애고 목적지마다 정해진 엷은 바탕색으로 바꿨습니다 — 칸 오른쪽 위에 목적지 세 글자';
