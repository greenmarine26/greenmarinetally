...
export const APP_NOTE = '미르 자체 학습 — 한 번 못 알아들은 말은 다음에 알아듣습니다 · 못 배운 말은 매일 클로드가 결산해 가르칩니다';
...
export const NO_SHIFT_SHIPS = ['OBWH', 'RZOR'];
