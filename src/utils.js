...
export const APP_VERSION = 'TallyOne 3.51-02'   // 3.51-02 TMPZ 양하 EDI 가 «NAD+CA+SOC»(화주 소유 표식)로 온 5대를 그 배 선사 TJM 으로 읽는다 — 김명보 부장 «TMPZ 양하 SOC는 TJM으로 바꾸시오» · 마감텔리 Final Work 에 없어야 할 SOC 줄이 서 있었다 · 3.51-01 관리 기록은 조회만도 적는다
...
export const APP_NOTE = 'TMPZ 양하에서 선사가 SOC 로 나오던 다섯 대를 TJM 으로 바로잡았습니다. 마감텔리 선사 줄도 같이 맞습니다'
