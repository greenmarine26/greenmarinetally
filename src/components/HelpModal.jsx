...
const CONTENT = {
  ...
  tips: [
    ...
    // M3.5.6: 카톡 작업 보고 매뉴얼
    {
      title: '🌐 검수 영어 회화집 (M3.5.6 신규)',
      examples: [
        { q: '시작 위치',             a: '헤더 우측의 [🌐 Languages] 버튼 (파란색)' },
        { q: '카테고리 12개',         a: '인사/승선, 양하, 선적, 컨테이너, 손상, 위치, 리퍼, 특수화물, 크레인, X-RAY, 안전, 마무리' },
        { q: '표현 138개',            a: '한글 + 영어 + 음성 들려주기 (TTS)' },
        { q: '음성 재생',             a: '각 표현 옆 [▶ 들려주기] 버튼 → 영어 발음 자동 재생' },
        { q: '검색',                  a: '한글/영어 검색창 → 즉시 필터링' },
        { q: '즐겨찾기',              a: '⭐ 별표 → 자주 쓰는 표현 모음' },
        { q: '재생 속도 조절',        a: '⚙️ 설정 → 0.5x ~ 1.5x (천천히/빠르게)' },
        { q: '활용 시나리오',         a: '외국 선원, 도선사, 외국 기사와 의사소통 시 즉시 표현 찾아 들려주기' },
      ],
    },
    {
