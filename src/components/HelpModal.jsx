  ...
  tips: [
    ...
    },
    {
      ...
      examples: [
        ...
        { q: '📍 부두 좌표 검수원 직접 등록 — M6.17', a: '문제: 코드의 PCTC/PNCT 좌표가 "대략" 추정값이라 현장에 있어도 외부로 잡히는 경우 발생. M6.17 수정: (1) 홈 화면 GPS 박스에 현재 좌표 + [🔄 다시 측정] (2) [📍 여기를 PCTC로 등록] / [📍 PNCT로 등록] 보라/파란 버튼 — 부두 도착 시 한 번 클릭 → 현재 GPS 좌표가 부두 좌표로 등록 (3) localStorage 즉시 적용 + Firebase 동기화 → 모든 검수원 공유 (4) maxDistance 2.5km → 5km 완화 (좌표 오차 마진 + 부두 범위). 사용자가 좌표 직접 보지 않아도 됨 — 부두에서 버튼 한 번이면 영구 해결.' },
