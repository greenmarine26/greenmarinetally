...
· 국적(선적국): …
· 길이 × 너비: …
· 건조년도 / 조선소: … (예: 2008년, 독일 Cassens Werft)
· 총톤수(GT) 또는 TEU: …

· 적재 능력: … (TEU 몇 대까지 싣는지. 리퍼 플러그 수를 알면 함께)
· 옛 이름(개명 이력): … (있으면 순서대로. 옛 이름으로 된 자료가 나올 때 같은 배인지 알아보려는 것이다)

[선사·관리]
· 등록 선주(Owner): … (회사명과 소재국)
· 관리 선사(Ship Manager / ISM): … (회사명과 소재지. 중국 선박이면 어느 시(市)인지까지)
· 국내 대리점: … (한국 입항 때 대리점 업무를 맡는 회사. 예: 두우해운)
