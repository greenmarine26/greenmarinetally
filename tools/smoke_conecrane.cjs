...
// ── 종전 동작을 안 깨뜨렸는가
{
  ok(/window\.__CONEV='ConeOne 2\.55'/.test(CONE), '콘앱 판이 2.55 이다(2.55 SW 범위 분리 · 2.54 기록지 사진 자리 · 2.46 호기 되살리기 위에 쌓인 판 · 2.48 미르 한 벌 · 2.50-01 접안방향 재료 · 2.52 미르 기분 · 2.53 표정 인형 · 2.53-01 트윈 티어 골격 · 2.53-02 카드 좌우·단 골격)');
